...
Tests for a2a protocol.test functionality in the Artinet SDK.

## Test Suites

- A2A Protocol Specification Tests
- Agent Card
- Task States
...
3. Run the tests with `npm test` or specifically with `npx jest a2a-protocol.test.ts`
