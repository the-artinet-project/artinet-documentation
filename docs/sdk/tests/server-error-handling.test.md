...
Tests for server error handling.test functionality in the Artinet SDK.
...
3. Run the tests with `npm test` or specifically with `npx jest server-error-handling.test.ts`
